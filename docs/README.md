...
本目录是 `dsh-cross-session` 的文档入口。先读本页，再按问题进对应文档组。事实只在一处写全，其他文档用链接引用。
...
4. [plan/layers.md](plan/layers.md) — 已交付 L0–L2.5 和未来 L2b–L6 全景。
5. 当前实现阶段：[plan/phase-l0.md](plan/phase-l0.md)、[plan/phase-l1.md](plan/phase-l1.md)、[plan/phase-l2.md](plan/phase-l2.md)、[plan/phase-l2.1.md](plan/phase-l2.1.md)、[plan/phase-l2.2.md](plan/phase-l2.2.md)、[plan/phase-l2.3.md](plan/phase-l2.3.md)、[plan/phase-l2.4.md](plan/phase-l2.4.md)、[plan/phase-l2.5.md](plan/phase-l2.5.md)。
